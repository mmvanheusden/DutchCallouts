...
{
    [CalloutInfo("Gevecht", CalloutProbability.Medium)]
    class Gevecht : Callout
    {
        private Ped _AG1;
        private Ped _AG2;
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            CalloutMessage = "~b~Meldkamer:~s~ Gevecht aan de gang";
        ...
        {
            Game.LogTrivial("DutchCallouts Log: Fighting callout accepted.");
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~DutchCallouts", "~y~Gevecht", "~b~Beldkamer: ~w~Stop de twee personen die aan het vechten zijn! reageer met ~r~CODE 3");
        ...
        public override void End()
        {
            ...
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~DutchCallouts", "~y~Gevecht", "~b~CODE 4");
