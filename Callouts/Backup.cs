...
{
    [CalloutInfo("Backup", CalloutProbability.Medium)]
    public class Backup : Callout
    {
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            {
                case 1:
                    this.CalloutMessage = "~b~Meldkamer:~s~ Voertuig Aanhouding Assistentie";
                    _callOutMessage = 1;
                    break;
                case 2:
                    this.CalloutMessage = "~b~Meldkamer:~s~ Voertuig Aanhouding Assistentie";
        ...
        {
            Game.LogTrivial("DutchCallouts Log: Voertuig Aanhouding Assistentie callout accepted.");
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~DutchCallouts", "~y~Voertuig Aanhouding Assistentie", "~b~Meldkamer:~w~ Een agent heeft assistentie nodig bij een aanhouding van een voertuig. Reageer met ~y~CODE 2~w~.");
