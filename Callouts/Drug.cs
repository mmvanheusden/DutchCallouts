...
{
    [CalloutInfo("Drug", CalloutProbability.Medium)]
    public class Drug : Callout
    {
        private string[] wepList = new string[] { "WEAPON_PISTOL", "WEAPON_BAT", "WEAPON_BOTTLE" };
        private string[] pedList = new string[] { "s_m_y_dealer_01", "u_m_o_tramp_01", "a_m_m_eastsa_01", "a_m_m_og_boss_01", "player_two", "g_m_y_lost_02" };
        ...
        {
            Game.LogTrivial("DutchCallouts Log: Drug callout accepted.");
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~DutchCallouts", "~y~Drugsdeal", "~b~Meldkamer: ~w~Probeer de verkoper en de koper te arresteren!. Reageer met ~y~CODE 2");
        ...
        public override void End()
        {
            ...
            Game.DisplayNotification("web_lossantospolicedept", "web_lossantospolicedept", "~w~DutchCallouts", "~y~DrugsDeal", "~b~CODE 4.");
