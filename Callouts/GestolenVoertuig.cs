...
{
    [CalloutInfo("GestolenVoertuig", CalloutProbability.High)]
    public class GestolenVoertuig : Callout
    {
        private Ped Suspect;
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            CalloutMessage = "Gestolen Voertuig";
        ...
        {
            SuspectVehicle = new Vehicle("SULTAN", SpawnPoint);
